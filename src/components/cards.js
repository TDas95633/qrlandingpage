    ...
    <div className='flex content-center items-center justify-start rounded-xl bg-white/50 drop-shadow-md' style={{ height: '20%', width: '80%' }}>
      <div className='flex-row gap-2 justify-center wiggle'>
        <a href={logoUrl}>
          <img
            src={icon}
            className={`bg-white/80 rounded-full clickable-element m-5 size-20 md shadow-2xl ${paddingClasses}`}
            alt=''
          />
        </a>
      </div>
      <div>
        ...
        <a className="text-xl md:text-2xl text-white font-bold" href={textUrl}>
          {textUrlDisplay}
        </a>
      </div>
    </div>
